...
public class ArcherHuman implements Archer {
    private String name;
    private int hp;
    private int level;
    ...
    public ArcherHuman(String name, int hp, int level) {
        this.name = name;
        this.hp = hp;
        this.level = level;
    }
    ...
    public void callSpecialAbility() {
        System.out.println("Elves are coming! Archers! Get ready! " + name + ability);
    }
}
