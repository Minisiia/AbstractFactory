...
public class WarriorHuman implements Warrior {
    private String name;
    private int hp;
    private int level;
    ...
    public WarriorHuman(String name, int hp, int level) {
        this.name = name;
        this.hp = hp;
        this.level = level;
    }
    ...
    public void callSpecialAbility() {
        System.out.println("Elves are coming! Warriors! Get ready! " + name + ability);
    }
}
